...
export default function ImageNodeEditor(props) {
	...
	const onChangeReactivity = useSetPropertySelected(editor, "reactive");
	...
	return (
		<NodeEditor description={ImageNodeEditor.description} {...props}>
			...
			<InputGroup name="Reactivity" info="Toggle audio reactivity.">
				<BooleanInput value={node.reactive} onChange={onChangeReactivity} />
			</InputGroup>
			<InputGroup
